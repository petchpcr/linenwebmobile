...
<head>
	...
	<script>
		...
		function senddata(data) {
			...
			$.ajax({
				url: '../process/ref_newlinentable.php',
				dataType: 'text',
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(result) {
					...
					if (temp["status"] == 'success') {
						if (temp["form"] == 'load_site') {
							...
							if (Menu == 'clean') {
								window.location.href = 'add_items.php?siteCode=' + siteCode + '&DepCode=' + DepCode + '&DocNo=' + DocNo + '&RefDocNo=' + RefDocNo + '&Menu=' + Menu + '&user=' + Userid + '&Delback=1' + txt_form_out;
							} else if (Menu == 'clean_real') {
								window.location.href = 'add_items_clean_real.php?siteCode=' + siteCode + '&DepCode=' + DepCode + '&DocNo=' + DocNo + '&RefDocNo=' + RefDocNo + '&Menu=' + Menu + '&user=' + Userid + '&Delback=1' + txt_form_out;
							}
