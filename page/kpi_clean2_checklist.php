...
<head>
	...
	<script>
		...
		function back() {
			window.location.href = 'kpi_clean2.php?siteCode=' + siteCode + txt_form_out;
		}
		...
		function senddata(data) {
			...
			var URL = '../process/kpi_clean2_checklist.php';
			$.ajax({
				url: URL,
				dataType: 'text',
				cache: false,
					...
					if (temp["status"] == 'success') {
						if (temp["form"] == 'load_question') {
							...
							for (var i = 0; i < temp['cnt']; i++) {
								...
								Str += "						<div class='col-2 text-center'>" + temp['Type'][i] + "</div>";
						...
						<tr class="bg-primary text-white">
							<th scope="col">
								<div class="row">
									...
									<div class="col-2 text-center"><?php echo $genarray['fabtyperandom'][$language]; ?></div>
