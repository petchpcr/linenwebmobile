	...
	<script>
		...
		function save_sign(dataURL) {
			...
			$.ajax({
				...
				method: "POST",
				data: {
					IsMenu: "signdoc_return_wash_detail",
					DocNo: DocNo,
					SignCode: dataURL,
		...
		function back() {
			window.location.href = 'signdoc_return_wash.php?siteCode=' + siteCode + txt_form_out;
		}
		...
		function senddata(data) {
			...
			var URL = '../process/signdoc_return_wash_detail.php';
			$.ajax({
				url: URL,
				dataType: 'text',
				cache: false,
			...
			<div class="col-lg-9 col-md-10 col-sm-12">
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-center py-2">
						<button id="btn_SignFac" class="btn btn-success btn-block mr-4" style="max-width:250px;" onclick="md_signature('SignFac')">
