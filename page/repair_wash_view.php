...
<head>
	...
	<script>
		...
		function movetoAddItem() {
			...
			window.location.href = 'add_items_repair_wash.php?siteCode=' + siteCode + '&DocNo=' + DocNo + '&Menu=' + Menu + '&user=' + Userid + '&DepCode=' + DepCode + '&RefDocNo=' + RefDocNo  + '&NotDelDetail=1' + txt_form_out;
		}
		...
		function senddata(data) {
			...
			var URL = '../process/repair_wash_view.php';
			$.ajax({
				url: URL,
				dataType: 'text',
				cache: false,
