...
<head>
	...
	<script>
		...
		function senddata(data) {
			...
			$.ajax({
				url: '../process/clean_ref_dirty.php',
				dataType: 'text',
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(result) {
					...
					if (temp["status"] == 'success') {
						if (temp["form"] == 'load_site') {
							...
							window.location.href = 'add_items_clean_real.php?siteCode=' + siteCode + '&DepCode=' + DepCode + '&DocNo=' + DocNo + '&Menu=' + Menu + '&user=' + Userid + '&Delback=1&Ref=dirty' + txt_form_out;
	...
	<div class="px-3 pb-4 mb-5">
		...
		<div id="document">
			...
			<div class="fixed-bottom py-2 px-3 bg-white d-flex justify-content-center">
				<button id="add_doc" onclick="add_dirty()" class="btn btn-success btn-block d-flex justify-content-center align-items-center" type="button" style="max-width:250px;">
