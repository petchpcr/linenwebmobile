...
<head>
	...
	<script>
		...
		function back() {
			window.location.href = Menu + ".php?siteCode=" + siteCode + "&Menu=" + Menu + "&From=" + From + txt_form_out;
		}
		// end function
