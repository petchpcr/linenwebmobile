...
<head>
	...
	<title><?php echo $genarray['titlecleanstock'][$language] . $genarray['titleDocument'][$language]; ?></title>
	...
	<script>
		...
		function add_clean() {
			var slt = $("#DocName").val();
			if (slt == 1) {
				window.location.href = 'ref_clean_real.php?siteCode=' + siteCode + '&DepCode=' + depCode + '&Menu=' + Menu + txt_form_out;
			} else if (slt == 2) {
				create_clean();
			}
		}
				...
				<div class="modal-body text-center">
					...
					<div class="input-group my-3">
						...
						<select onchange="change_doc()" id="DocName" class="custom-select">
							<option value="1"><?php echo $array['refDocClean'][$language]; ?></option>
							<option value="2"><?php echo $array['NotRefDoc'][$language]; ?></option>
						</select>
					</div>
